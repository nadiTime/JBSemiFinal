 ...
 ?>
 	<section>
	 	<div id="person" class="row">
		 	<div id="profile-picture" class="2u 4u(medium) -2u(medium)">	
		 		<img src=""/>
			...
			<div id="user_details" class="4u 4u$(medium)">
			...
			<div id="secret_data" class="4u$ -2u(medium)">
				<div class="row">
					<div class="6u">
		...
		<div id="posts" class="row">
			<div id="new_post" class="10u$">
				<textarea id="placeToWritePosts" placeholder="Whats on yur mind?"></textarea>
